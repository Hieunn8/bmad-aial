...
I want to deliver **Document Ingestion Pipeline (FR-R1)** with measurable acceptance checks,
so that Epic 3 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **3.1 - Document Ingestion Pipeline (FR-R1)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/3-1-document-ingestion-pipeline.md`.
