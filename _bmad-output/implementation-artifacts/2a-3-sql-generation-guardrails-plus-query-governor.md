...
I want to deliver **SQL Generation Guardrails + Query Governor** with measurable acceptance checks,
so that Epic 2A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2A.3 - SQL Generation Guardrails + Query Governor** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2a-3-sql-generation-guardrails-plus-query-governor.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2A.3
