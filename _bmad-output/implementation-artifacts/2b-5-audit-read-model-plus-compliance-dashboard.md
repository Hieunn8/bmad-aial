...
I want to deliver **Audit Read Model + Compliance Dashboard** with measurable acceptance checks,
so that Epic 2B can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2B.5 - Audit Read Model + Compliance Dashboard** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2b-5-audit-read-model-plus-compliance-dashboard.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2B.5
