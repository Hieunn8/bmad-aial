...
I want to deliver **Semantic Layer Bootstrap + Business Glossary API** with measurable acceptance checks,
so that Epic 2A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2A.2 - Semantic Layer Bootstrap + Business Glossary API** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2a-2-semantic-layer-bootstrap-plus-business-glossary-api.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2A.2
