...
I want to deliver **Semantic Result Cache (FR-S6)** with measurable acceptance checks,
so that Epic 6 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **6.3 - Semantic Result Cache (FR-S6)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/6-3-semantic-result-cache.md`.
