...
I want to deliver **Chart Reveal + Data Freshness Signals (UX-DR9)** with measurable acceptance checks,
so that Epic 2B can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2B.4 - Chart Reveal + Data Freshness Signals (UX-DR9)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
2. Tất cả yêu cầu liên quan được trace được về Epic 2B (ví dụ: Các yêu cầu chức năng/NFR liên quan trong epics.md).
...
- Epic context: **Epic 2B — Trust & Audit Layer**.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2b-4-chart-reveal-plus-data-freshness-signals.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2B.4
