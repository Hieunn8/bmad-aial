...
I want to deliver **Full ABAC Extension (FR-A2 Full)** with measurable acceptance checks,
so that Epic 4 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **4.1 - Full ABAC Extension (FR-A2 Full)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/4-1-full-abac-extension.md`.
