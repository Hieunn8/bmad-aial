...
I want to deliver **Audit Dashboard (FR-AD4)** with measurable acceptance checks,
so that Epic 5A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **5A.3 - Audit Dashboard (FR-AD4)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/5a-3-audit-dashboard.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 5A.3
