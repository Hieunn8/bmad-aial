...
I want to deliver **User & Role Management (FR-AD2)** with measurable acceptance checks,
so that Epic 5A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **5A.1 - User & Role Management (FR-AD2)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/5a-1-user-and-role-management.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 5A.1
