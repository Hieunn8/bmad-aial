...
I want to deliver **Onboarding Shell + First-Query Scaffold** with measurable acceptance checks,
so that Epic 2A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2A.9 - Onboarding Shell + First-Query Scaffold** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2a-9-onboarding-shell-plus-first-query-scaffold.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2A.9
