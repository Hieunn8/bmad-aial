...
I want to deliver **Pre-retrieval Policy Filtering (FR-R2)** with measurable acceptance checks,
so that Epic 3 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **3.2 - Pre-retrieval Policy Filtering (FR-R2)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/3-2-pre-retrieval-policy-filtering.md`.
