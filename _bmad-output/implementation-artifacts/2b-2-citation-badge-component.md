...
I want to deliver **Citation Badge Component (UX-DR10 — BUILD HERE)** with measurable acceptance checks,
so that Epic 2B can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2B.2 - Citation Badge Component (UX-DR10 — BUILD HERE)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2b-2-citation-badge-component.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2B.2
