...
I want to deliver **Streaming Chat UI + SSE Transport** with measurable acceptance checks,
so that Epic 2A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2A.5 - Streaming Chat UI + SSE Transport** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2a-5-streaming-chat-ui-plus-sse-transport.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2A.5
