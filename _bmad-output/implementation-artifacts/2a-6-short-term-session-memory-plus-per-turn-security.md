...
I want to deliver **Short-term Session Memory + Per-Turn Security** with measurable acceptance checks,
so that Epic 2A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2A.6 - Short-term Session Memory + Per-Turn Security** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2a-6-short-term-session-memory-plus-per-turn-security.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2A.6
