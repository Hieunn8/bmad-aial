...
I want to deliver **Trend Analysis (FR-F3)** with measurable acceptance checks,
so that Epic 7 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **7.3 - Trend Analysis (FR-F3)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/7-3-trend-analysis.md`.
