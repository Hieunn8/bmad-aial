...
I want to deliver **Admin Document Management (FR-R5)** with measurable acceptance checks,
so that Epic 3 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **3.5 - Admin Document Management (FR-R5)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/3-5-admin-document-management.md`.
