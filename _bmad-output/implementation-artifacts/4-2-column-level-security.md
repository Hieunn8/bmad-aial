...
I want to deliver **Column-level Security (FR-A4)** with measurable acceptance checks,
so that Epic 4 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **4.2 - Column-level Security (FR-A4)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/4-2-column-level-security.md`.
