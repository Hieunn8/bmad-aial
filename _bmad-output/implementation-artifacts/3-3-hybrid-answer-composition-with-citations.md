...
I want to deliver **Hybrid Answer Composition with Citations (FR-R3)** with measurable acceptance checks,
so that Epic 3 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **3.3 - Hybrid Answer Composition with Citations (FR-R3)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
2. Tất cả yêu cầu liên quan được trace được về Epic 3 (ví dụ: Các yêu cầu chức năng/NFR liên quan trong epics.md).
...
- Epic context: **Epic 3 — Document Intelligence & Hybrid Answers**.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/3-3-hybrid-answer-composition-with-citations.md`.
