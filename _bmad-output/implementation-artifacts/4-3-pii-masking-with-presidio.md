...
I want to deliver **PII Masking with Presidio (FR-A5)** with measurable acceptance checks,
so that Epic 4 can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **4.3 - PII Masking with Presidio (FR-A5)** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/4-3-pii-masking-with-presidio.md`.
