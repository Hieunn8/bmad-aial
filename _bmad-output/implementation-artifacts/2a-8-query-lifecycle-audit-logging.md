...
I want to deliver **Query Lifecycle Audit Logging** with measurable acceptance checks,
so that Epic 2A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2A.8 - Query Lifecycle Audit Logging** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2a-8-query-lifecycle-audit-logging.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2A.8
