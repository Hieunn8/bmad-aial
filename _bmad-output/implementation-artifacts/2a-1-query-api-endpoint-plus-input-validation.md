...
I want to deliver **Query API Endpoint + Input Validation** with measurable acceptance checks,
so that Epic 2A can progress safely with verifiable outcomes.

## Acceptance Criteria

1. Hành vi/đầu ra của story **2A.1 - Query API Endpoint + Input Validation** bám đúng phạm vi mô tả trong `_bmad-output/planning-artifacts/epics.md`.
...
- Primary artifact file: `_bmad-output/implementation-artifacts/2a-1-query-api-endpoint-plus-input-validation.md`.
...
- `_bmad-output/planning-artifacts/epics.md` — Story 2A.1
